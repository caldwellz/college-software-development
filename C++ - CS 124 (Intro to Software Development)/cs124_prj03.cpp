/***********************************************************************
* Program:
*    Project 03, Monthly Budget (with tax placeholder)
...
*    Estimated:  0.75 hrs
*    Actual:     0.33 hrs
*      The hardest part was probably the big refactor of project 02 to fit
*      the function diagram; after that I just had to tweak a couple things
*      to turn it into project 03.
************************************************************************/
